...
This repository is for a UCSB workshop on Feb. 24. It was created from The Carpentries' ([Software Carpentry][swc-site], [Data Carpentry][dc-site], and
[Library Carpentry][lc-site]'s) template for creating websites for workshops.

Up to here on customizing:
